...
public class BTPAzureProxyServletAKS extends HttpServlet
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(BTPAzureProxyServletAKS.class);
    private static final String DESTINATION_NAME = "aks";

    @Override
    protected void doGet( final HttpServletRequest request, final HttpServletResponse response )
        throws ServletException, IOException
    {      
        String uriReplaced = request.getRequestURI().trim().split("/k8s")[1];
